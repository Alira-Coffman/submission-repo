 ...
 *
 * Created: 10/9/2019 5:32:11 PM
 * Author : alira
 * Design a delay subroutine to generate a waveform on PORTB.3 with 40% DC and 0.625 sec period using Timer 0 – normal mode. Count OVF
